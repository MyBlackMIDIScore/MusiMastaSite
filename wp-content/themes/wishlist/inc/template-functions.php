...
//=============================================================
function wishlist_register_required_plugins() {
	
	$plugins = array(
				
		array(
			'name'      => esc_html__( 'Elementor Page Builder', 'wishlist' ),
			'slug'      => 'elementor',
			'required'  => false,
		),

		array(
			'name'      => esc_html__( 'Post Grid Elementor Addon', 'wishlist' ),
			'slug'      => 'post-grid-elementor-addon',
			'required'  => false,
		),

		array(
			'name'      => esc_html__( 'Instagram Feed For Elementor', 'wishlist' ),
			'slug'      => 'ifeed-for-elementor',
			'required'  => false,
		),

		array(
			'name'      => esc_html__( 'WooCommerce', 'wishlist' ),
			'slug'      => 'woocommerce',
			'required'  => false,
		),

		array(
			'name'      => esc_html__( 'WooCommerce Product Tabs', 'wishlist' ),
...
add_action( 'tgmpa_register', 'wishlist_register_required_plugins' );